"""
Simplified Hint Token API Endpoints for Testing
This bypasses the complex TokenService transaction logic to test basic functionality
"""
...
@router.post("/use-simple", response_model=HintUseResponse)
async def use_hint_token_simple(
    current_user: dict = Depends(get_current_user_with_permissions)
):
    """
    Simplified hint token usage endpoint for testing
    """
    try:
