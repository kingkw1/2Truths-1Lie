...
export const MediaRecorder: React.FC<MediaRecorderProps> = ({
  ...
  const requestPermissions = useCallback(async (type: MediaType) => {
    if (type === 'text') {
  ...
  }, [disabled, allowedTypes, maxDuration, onRecordingComplete, onRecordingError, checkMediaSupport, requestPermissions, recordingState.duration]);
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <p style={styles.subtitle}>
          Choose how you'd like to record your statement. Video and audio add personality to your challenge!
        </p>
      </div>
        ...
        <div style={styles.typeSelection}>
          {allowedTypes.includes('video') && (
            <button
              ...
              style={{
                ...styles.typeButton,
                ...(recordingState.mediaType === 'video' ? styles.typeButtonActive : {}),
              }}
              disabled={disabled}
            >
          ...
          {allowedTypes.includes('audio') && (
            <button
              ...
              style={{
                ...styles.typeButton,
                ...(recordingState.mediaType === 'audio' ? styles.typeButtonActive : {}),
              }}
              disabled={disabled}
            >
              <span style={styles.typeIcon}>🎤</span>
          ...
          {allowedTypes.includes('text') && (
            <button
              ...
              style={{
                ...styles.typeButton,
                ...(recordingState.mediaType === 'text' ? styles.typeButtonActive : {}),
              }}
              disabled={disabled}
            >
              <span style={styles.typeIcon}>📝</span>
...
const TextRecorder: React.FC<TextRecorderProps> = ({ onComplete, disabled }) => {
